...
| `client/src/pages/erp/ordersHub/` | Orders Hub overview, Shopify page, ChannelGuide + key-acquisition guides |
| `client/src/pages/erp/ebay.jsx` | eBay Sell: credentials, SKU maps, pending order queue, inventory push, analytics (under Orders Hub) |
