...
import Erp, {
  ...
  InvoicesPage as ErpInvoices,
  SalesDocDetailPage as ErpSalesDocDetail,
} from './pages/Erp';
      ...
      <div id="layout">
        ...
        <main id="main" className="grid-lines-bg">
          ...
          <Routes>
            ...
            <Route path="/erp/delivery-notes" element={<ErpDeliveryNotes />} />
            <Route path="/erp/invoices"       element={<ErpInvoices />} />
            <Route path="/erp/sales-docs/:id" element={<ErpSalesDocDetail />} />
